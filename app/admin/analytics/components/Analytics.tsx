...
export function Analytics() {
    ...
    if (loading) {
        return <div className='min-h-screen flex justify-center items-center'><Loader size='lg' /></div>;
    }

    if (!analytics) {
        return <div className='min-h-screen flex justify-center items-center text-3xl'>No analytics data available</div>;
    }
        ...
        <div className="space-y-6">
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
                <Card>
                    ...
                    <CardContent>
                        <div className="text-2xl font-bold">{analytics.totalItemsPurchased}</div>
                    </CardContent>
                </Card>
                <Card>
                    <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                    ...
                    <CardContent>
                        <div className="text-2xl font-bold">${analytics.totalPurchaseAmount.toFixed(2)}</div>
                    </CardContent>
                </Card>
                <Card>
                    <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                    ...
                    <CardContent>
                        <div className="text-2xl font-bold">${analytics.totalDiscountAmount.toFixed(2)}</div>
                    </CardContent>
                </Card>
                <Card>
                    <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                    ...
                    <CardContent>
                        <div className="text-2xl font-bold">{analytics.discountCodes.length}</div>
                    </CardContent>
                </Card>
            </div>
            <Card>
