...
export function CheckoutModal({
  ...
  const [applyDiscountLoading, setApplyDiscountLoading] =
  ...
  const handleConfirmOrder = async () => {
    try {
      ...
      const payload =
        appliedDiscount && appliedDiscountId
          ...
          <>
                ...
                {discountCodes.map((discountCode) => (
                  ...
                  >
                    ...
                    <Button
                      ...
                      disabled={
                        !!appliedDiscount ||
                        discountCode.code === appliedDiscount
                      }
                      onClick={() =>
                        handleApplyDiscount(discountCode.code, discountCode.id)
                      }
                    >
            ...
            <DialogFooter className="mt-6">
              ...
              <Button onClick={handleConfirmOrder}>
                {placeOrderLoading ? <Loader size="xs" /> : 'Confirm Order'}
              </Button>
            </DialogFooter>
          </>
        )}
